...
export default function IndonesiaMap({ 
  ...
  const getStyleForLayer = (layerKey: string) => {
    ...
    return (feature?: Feature<Geometry, any>) => {
      ...
      // Risk analysis layer styling (tab Kerawanan)
      if (layerKey.includes('/api/risk-analysis') || layerKey.includes('detail_layer_')) {
      ...
      // Mitigation layer styling (bukan boundary)
      ...
      // ENHANCED: Apply risk-based coloring untuk Provinsi dan DAS di tab Mitigasi/Adaptasi
